...
namespace IBCustomerSite.Controllers
{
    public class AccountsController : Controller
    {
        ...
        public AccountsController(MCBAContext context)
        {
            _context = context;
        }
        ...
        {
            var mCBAContext = _context.Accounts.Include(a => a.Customer);
        ...
        public async Task<IActionResult> Create([Bind("AccountNumber,AccountType,CustomerID")] Account account)
        {
            ...
            ViewData["CustomerID"] = new SelectList(_context.Customers, "CustomerID", "Name", account.CustomerID);
            return View(account);
        }
